      ...
      <main className="items-center p-5 min-w-full min-h-screen  pt-20">
        ...
        <p className="pb-4 text-2xl font-bold text-cyan-800 heading">Support</p>
          ...
          <ul className="text-left text-cyan-700 md:text-center">
            <a href="https://cvabonline.com"><p className='font-bold text-cyan-500 underline'>Pier 360</p></a>
            <li><a href="https://www.cvabonline.org/s/Pier360-West-January-2025-Final.pdf">West center calendar</a></li>
            <li><a href="https://www.cvabonline.org/s/Pier360-East-January-2025-Final.pdf">East center calendar</a></li>
            <li><a href="https://www.cvabonline.org/services">Information on services provided</a></li>
            <li><a href="https://www.cvabonline.org/training">Pier 360 academy</a></li>
            <li><a href="https://www.cvabonline.org/warmline">Warm Line</a></li>
            </ul>
            </div>
            <ul className='text-left text-cyan-700 md:text-center'>
            <p className='font-bold text-cyan-500'>Recovery Cafe</p>
