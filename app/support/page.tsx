export default async function Home() {
  return (
    <main className="items-center p-5 min-w-full min-h-screen  pt-20">
      <div className="p-3 mx-auto text-center rounded-2xl shadow-sm shadow-gray-400 bg-cyan-50/10 backdrop-blur-sm w-full">
          ...
          <div className="flex flex-col mx-3">
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://cvabonline.com">
                <p className="font-bold text-cyan-800 underline">Pier 360</p>
              </a>
            ...
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://www.recoverycafecc.org/">
                <p className="font-bold text-cyan-800 underline">Recovery Cafe</p>
              </a>
            ...
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://couvecollective.org/">
                <p className="font-bold text-cyan-800 underline">Couve Collective</p>
              </a>
          ...
          <div className="flex flex-col mx-3">
            ...
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://www.restoredandrevived.com/">
                <p className="font-bold text-cyan-800 underline">Restored & Revived</p>
              </a>
              ...
              <li><a href="https://www.restoredandrevived.com/programs-and-services">Programs & Services</a></li>
            </ul>
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://www.vancouveraa.org/">
                <p className="font-bold text-cyan-800 underline">AA</p>
              </a>
            ...
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://swanaonline.org/">
                <p className="font-bold text-cyan-800 underline">NA</p>
              </a>
            ...
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://heroinanonymous.org/">
                <p className="font-bold text-cyan-800 underline">HA</p>
              </a>
              
              <li>
                <a href="https://heroinanonymous.org/resources/">
                  Resources
                </a>
              </li>
              <li><a href="https://heroinanonymous.org/meetings1/">Meetings</a></li>
            </ul>
            <ul className="text-left text-cyan-700 md:text-left">
              <a href="https://smartrecovery.org/">
                <p className="font-bold text-cyan-800 underline">Smart Recovery</p>
              </a>
