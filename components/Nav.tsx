...
export default function Nav() {
  ...
  return (
    ...
    >
      ...
      <div className="justify-end flex sm:hidden text-black w-full py-3 px-5">
      <div className="relative group">
  <div className="flex flex-col space-y-[2px]">
    <span className="w-5 h-1 border-b-[3px] border-cyan-900 rounded-md"></span>
    <span className="w-5 h-1 border-b-[3px] border-cyan-900 rounded-md"></span>
    <span className="w-5 h-1 border-b-[3px] border-cyan-900 rounded-md"></span>
  </div>
  ...
  <ul
        className={`text-cyan-900 flex flex-col space-y-2`}
      >
        <li className="">
          <a
            id="link"
